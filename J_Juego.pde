class Juego {
  ...
  Cronopio cronopio;
  Escenario escenario;
  Huevo huevo, huevo1, huevo2, huevo3, huevo4, huevo5, huevo6, huevo7, huevo8, huevo9;
  ...
  void dibujar() {
    ...
    if (estadoJ==0) {
      //estado es 0 se ejecuta los eventos del juego
      escenario.dibujar();
      cronopio.dibujar();
      HuevosPorEstado();
      tiempo.dibujar();
